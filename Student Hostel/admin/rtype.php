...
<table width="1023" height="400" border="1">
  <tbody>
    ...
    <tr>
	  ...
	  </div><h2><center>ROOM TYPES</h2></center>
	  <?php
...
if(isset($_POST['search']))
{
    ...
    $query = "SELECT * FROM `roomtype` WHERE CONCAT(`room_id`, `room_type`, `room_price`, `room_seson`) LIKE '%".$valueToSearch."%'";
   ...
   <body>
      ...
      <!-- populate table from mysql database -->
                ...
                <tr>
					...
					<td><center><?php echo $row['room_price'];?></center></td>
                    <td><center><?php echo $row['room_seson'];?></center></td>
					<td><a href='http://localhost/phpmyadmin/sql.php?server=1&db=hostel&table=roomtype&pos=0'>Delete</a></td>
                </tr>
