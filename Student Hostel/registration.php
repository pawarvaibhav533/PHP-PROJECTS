...
$na = "SELECT username FROM users WHERE username='$un'";
$cq = mysqli_query($con,$na);
...
{
	$query = "INSERT INTO users VALUES ('','$n','$c','$add','$dob','$gen','$mob','$em','$un','$p')";
...
<form method="post" enctype="multipart/form-data">
    ...
    <p><b>Full Name : </b><input type="text" name="name" required/>*</p>
    <p><b>Class : </b><input type="varchar" name="classs" required/>*</p>
    <p><b>Address : </b><textarea placeholder="Input Address" name="address"></textarea></p>
	<p><b>DOB : </b><input type="date" name="dob" required/>*</p>
	<p><b>Gender : </b><input type="radio" name="gender" value="m">Male&nbsp;<input type="radio" name="gender" value="f">Female</p>
	<p><b>Mobile No. : </b><input type="text" name="mob" required/>*</p>
